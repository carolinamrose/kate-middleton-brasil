...
<div id="minipost">
<div class="minipost">
	<?php $excerpt = get_the_excerpt(''); echo string_limit_words($excerpt,21);?> <a href="<?php the_permalink() ?>">(LEIA +)</a></div>
<div class="miniautor">
...
<a href="http://katemiddletonbrasil.com/noticias">ver em modo completo</a>
</div></div>
...
<?php 
    echo do_shortcode("[metaslider id=1887]"); 
?>
</div>
...
<div id="box">
<div id="data-agenda">11/03</div> 
<div id="evento">Commonwealth Day na Abadia de Westminster</div><br>
<div id="data-agenda">19/03</div> 
<div id="evento">Compromisso com a Rainha na King’s College</div>
</div>
</div>
	
<div class="parceiros">
<?php echo do_shortcode("[metaslider id=352]"); ?><div id="parceiros">Parceiros</div>
</div>

<div id="ultimas"><div class="galeria">
Últimas da Galeria</div><div id="fotos">

<iframe src="http://katemiddletonbrasil.com/galeria/cpmfetch/latestimages.php"  TARGET='_blank'marginwidth="0" marginheight="0" 100px="" 300px="" frameborder="0" height="153" scrolling="no" width="804"></iframe>
</div></div>
